function h = UPVP_zjq(f, gamma)
    ...
    W = repmat(cumsum(ones(1,N),2),R,1);  % (FirstDim) indices are 0, 1, 2, ...
    ...
    for i = 1:R
        r = N; l = J(i,r);
        while(l > 0)
            h(i,l+1:r,:) = repmat((M(i,r,:)-M(i,l,:))/(r-l),r-l,1);
            r = l;l = J(i,r);
        end
        h(i,1:r,:) = repmat((M(i,r,:))/r,r-l,1);
    end
end